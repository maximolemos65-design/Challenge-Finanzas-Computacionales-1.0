...
@page {
  size: A4;           /* o 'auto' si preferís que ajuste */
  margin: 0;          /* sin bordes */
}

/* 2) Reglas generales para impresión limpia */
@media print {
  html, body {
    height: 100%;
    margin: 0 !important;
  ...
  [data-testid="stToolbar"],     /* barra superior con logo Streamlit */
  [data-testid="stStatusWidget"],
  .stButton                       /* botones st.button */
  { display: none !important; }

  /* Quitar padding del contenedor central */
  ...
  /* Evitar cortes feos en tablas/gráficos */
  img, table, figure, .element-container {
    page-break-inside: avoid;
    break-inside: avoid;
  }
}

/* 3) También sacar padding en pantalla para que el PDF se vea sin márgenes */
[data-testid="block-container"]{
...
document.getElementById("print-btn").addEventListener("click", function(){
  if (parent && parent.window) parent.window.print();
  else window.print();
});
</script>
""", height=90)
